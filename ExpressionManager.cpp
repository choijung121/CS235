...
//((infixExpression[i]=='*'||infixExpression[i]=='-'||infixExpression[i]=='+'||infixExpression[i]=='/'||infixExpression[i]=='%')&&((postfixExpression==""||infixExpression[i-2]=='('||infixExpression[i-2]=='['||infixExpression[i-2]=='{'||infixExpression[i-2]=='+'||infixExpression[i-2]=='-'||infixExpression[i-2]=='*'||infixExpression[i-2]=='/'||infixExpression[i-2]=='%')||(infixExpression[i+2]==')'||infixExpression[i+2]==']'||infixExpression[i+2]=='}'||infixExpression[i+2]=='+'||infixExpression[i+2]=='-'||infixExpression[i+2]=='*'||infixExpression[i+2]=='/'||infixExpression[i+2]=='%'))||infixExpression[i]=='.')
